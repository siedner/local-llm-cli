...
COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        ...
        aliases=("/select",),
        category="Runtime",
        description="Select the active model for chat and runtime commands",
        argument_hint="<repo>",
    ...
    CommandSpec(
        ...
        aliases=("/serve",),
        category="Runtime",
        description="Start, stop, or inspect the daemon-backed runtime",
        argument_hint="start|stop|status|options [flags]",
        examples=("/runtime start", "/runtime status"),
    ...
    CommandSpec(
        ...
        aliases=(),
        category="Runtime",
        description="Manage the background daemon and launchd agent",
    ...
    CommandSpec(
        ...
        aliases=("/ps",),
        category="Runtime",
        description="Show the current daemon runtime snapshot",
    ...
    CommandSpec(
        ...
        argument_hint="[preset|temp|top_p|top_k|max_tokens|max_context|keep_alive|safe|system_prompt|reset]",
        examples=("/config", "/config safe off", "/config max_context 8192"),
    ),
    CommandSpec(
